...
export async function updateAdminProfile(payload: AdminProfileUpdateInput): Promise<LoggedUser> {
  return request<LoggedUser>('/me/profile', {
    method: 'PATCH',
    body: JSON.stringify(payload),
  })
}

export async function changeAdminPassword(payload: AdminPasswordChangeInput): Promise<{ success: boolean }> {
